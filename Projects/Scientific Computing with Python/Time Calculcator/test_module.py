...
class UnitTests(unittest.TestCase):
    ...
    def test_same_period(self): # Currently works
    ...
    def test_different_period(self): # Currently works
    ...
    def test_next_day(self): # Currently works
    ...
    def test_two_days_later(self): # Currently works
    ...
    def test_high_duration(self): # Currently works
    ...
    def test_no_change(self): # Currently works
